...
def attendance_take(request, team_id):
    ...
    if not Attendance.objects.filter(date=current_date, team=team):
        ...
        if request.method == "POST":
            ...
            return redirect("detail",team_id)
...
def attendance_update(request,attendance_id):
    ...
    if attendance.date == date.today():
        ...
        return HttpResponse("Faqatgina bugungina sanada davomatlarni tahrirlash mumkin")
